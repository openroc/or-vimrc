...
" Constant, sample: string 'xxx'
hi Constant	cterm=bold ctermfg=darkyellow
" Special, sample: end of line '\'
hi Special	ctermfg=5   
" Indentifier, sample: function name 
...
hi Todo   cterm=bold ctermfg=white ctermbg=darkgreen


hi Pmenu         guifg=White ctermfg=White ctermbg=DarkBlue gui=bold cterm=bold
